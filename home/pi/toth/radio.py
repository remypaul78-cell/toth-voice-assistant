...
RADIOS = {
    ...
    "nrj":       ("NRJ",          "http://cdn.nrjaudio.fm/adwz2/fr/30001/mp3_128.mp3"),
    "skyrock":   ("Skyrock",      "http://icecast.skyrock.net/s/natio_mp3_128k"),
    "fun":       ("Fun Radio",    "http://stream.funradio.sk:8000/fun128.mp3"),
    "reggae":    ("1.FM Reggae",  "http://strm112.1.fm/reggae_mobile_mp3"),
    "dub":       ("FuseCity Dub", "http://broadcast.shoutstream.co.uk:8074/stream"),
    "ragga":     ("Hoodoo Radio", "https://s4.radio.co/s76f8b99fc/listen"),
}
